...
import { useRegisterMutation } from "../customHooks/Auth/useRegisterMutation";
export function RegisterForm({ onSwitchForm }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (password !== passwordConfirmation) {
      setErrorNotification("Passwords do not match. Please try again.");
      return;
    }
